...
async function showDetails(test, listener) {
    ...
    // response = await fetch(`https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol=${test}&apikey=demo`);

    response = await fetch(`https://www.alphavantage.co/query?function=${sometime}&symbol=${test}&interval=5min&apikey='G6CHQDRI9H925YD3'`);
    ...
    if(sometime === "TIME_SERIES_INTRADAY"){
        ...
        timeSeries = data["Weekly Time Series"]["2023-07-21"]["1. open"]
